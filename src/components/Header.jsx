            ...
            <div className="header">
                <div className="intro-header">
                    ...
                    <div className="account">
                        ...
                        : 
                            <React.Fragment>
                                <span className="user" onClick={() => handleDropdown()}>
                                    ...
                                    <span className="in-user">
                                        ...
                                        <Image width={14} height={14} src="data:image/png;base64," />
                                    </span>
                                </span>
                                {dropdown &&
                                <div className="dropdown">
                                    <Link href={user !== null ? `/profile/${encodeURIComponent(user.username)}`: "/"}>
                                        <a>
                                            <Image width={16} height={16} src="https://img.icons8.com/small/16/000000/user.png"/>
                                            <span>Профиль</span>
                                        </a>
                                    </Link>
